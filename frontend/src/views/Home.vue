    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single text, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world of up to <span class=”highlight-orange”>millions of Agents</span> based on the real-world seeds within it. By injecting variables from a god's-eye view, it finds <span class=”highlight-code”>”local optima”</span> in complex group interactions under dynamic environments.
            </p>
            <p class="slogan-text">
              Let the future rehearse among Agents, let decisions prevail through countless simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Average $5/simulation</div>
            </div>
            <div class="metric-card">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction needs & dynamic temporal memory</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with anyone in the simulated world & converse with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction needs in natural language (e.g. What public opinion shift would occur if Wuhan University reverses the punishment of Student Xiao)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Redirect to Process page immediately (using special identifier for new project)
    router.push({
      name: 'Process',
...
.console-box {
  ...
  padding: 8px; /* Padding creates double-border effect */
}
